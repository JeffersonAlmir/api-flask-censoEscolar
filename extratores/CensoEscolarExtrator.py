...
def armazenar_microdados_educacao(entidades_info):  
    try:
            #passo1
...
if __name__ == "__main__": 
    ...
    totalInstituicoes = armazenar_microdados_educacao(entidates_info)
    ...
    totalUpdate = atualizarMicro_e_Meso( dataList)
    print('concluido')
